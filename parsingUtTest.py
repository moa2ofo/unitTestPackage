...
# ==============================
moduli = [
    {"nome_modulo": "VoltMon.c", "nome_funzione": "VoltMon_Run",
     "percorso": "../../elop_048/platform/basic_sw_platform/monitoring/test"},
    {"nome_modulo": "SpeedMon.c", "nome_funzione": "SpeedMon_Run",
     "percorso": "../../elop_048/platform/basic_sw_platform/monitoring/test"},
    {"nome_modulo": "CurrentMon.c", "nome_funzione": "CurrentMon_Derating",
     "percorso": "../../elop_048/platform/basic_sw_platform/monitoring/test"},
    {"nome_modulo": "LinStub.c", "nome_funzione": "ApplLinDiagEcuReset",
     "percorso": "../../elop_048/platform/basic_sw_platform/monitoring/test"},
    {"nome_modulo": "BridgeCtrl.c", "nome_funzione": "OffStateHandler",
     "percorso": "../../elop_048/platform/basic_sw_platform/monitoring/test"},
]
...
if __name__ == "__main__":
    ...
    for modulo in moduli:
        ...
        if extracted_body:
            ...
            modify_file_after_marker(os.path.join(base_directory, f"TEST_{function_name}", "src", f"{function_name}.c"),
                                     extracted_body)
